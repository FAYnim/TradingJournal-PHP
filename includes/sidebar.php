<aside id="sidebar" class="sidebar">
        ...
        <nav id="main-nav">
            <a href="#" id="nav-view" data-page="view-orders" class="active"><i class="fas fa-history icon-left"></i> Riwayat Aktif</a>
            <a href="#" id="nav-archive" data-page="archive-orders"><i class="fas fa-archive icon-left"></i> Arsip</a>
